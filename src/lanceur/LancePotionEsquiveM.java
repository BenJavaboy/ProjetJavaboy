...
public class LancePotionEsquiveM extends LancePotion{
	
	private static String usage = "USAGE : java " + LancePotion.class.getName() + " [ port [ ipArene ] ]";

	public void lancerPotionEsquiveM(int port , String ipArene)
	{
		String nom = "Potion d'esquive";
		...
		try {
			...
			caracts.put(Caracteristique.ESQUIVE, -20);
			caracts.put(Caracteristique.DEFENSE, 0);
			
			
			// ajout de la potion
			arene.ajoutePotion(new Potion("Potion d'esquive", "G7", caracts), Calculs.positionAleatoireArene());
	...
	public static void main(String[] args) {
		...
		p.lancerPotionEsquiveM(port,ipArene);
	}
}

...
public class LancePotion {
	...
	public void lancerPotion(int port , String ipArene)
	{
		String nom = "Anduril";
		...
		try {
			...
			caractsPotion.put(Caracteristique.DEFENSE, Calculs.valeurCaracAleatoirePosNeg(Caracteristique.DEFENSE));
			caractsPotion.put(Caracteristique.ESQUIVE, Calculs.valeurCaracAleatoirePosNeg(Caracteristique.ESQUIVE));

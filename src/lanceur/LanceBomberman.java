...
import client.StrategieBomberman;
...
public class LanceBomberman  {

	private static String usage = "USAGE : java " + LancePersonnage.class.getName() + " [ port [ ipArene ] ]";

	public void lancerBomberman(int port , String ipArene)
	{
		String nom = "Bomberman";
		...
		try {
			...
			new StrategieBomberman(ipArene, port, ipConsole, nom, groupe, caracts, nbTours, position, logger, 0);
			logger.info("Lanceur", "Creation du personnage Bomberman reussie");
	...
	public static void main(String[] args) {
		...
		b.lancerBomberman(port,ipArene);
	}
